...
/*
 * còn có thể nâng cấp - hoàn thiện date - throw 1 dạng Error cụ thể - sanitize input của từng lúc
 * sử dụng hàm vd getString(null, null, null)
 */
...
public class Inputter {
    ...
    // String str = String.format("%2d/%2d/%4d", date.getDate(), date.getMonth()+1,
    // date.getYear()+1900);
    // return str;
    // }
